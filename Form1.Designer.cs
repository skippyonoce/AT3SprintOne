namespace AT3SprintOne
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.toolTip1.SetToolTip(this.listBox1, "This listbox will show the current state of \r\nthe data set loaded/stored in the p" +
        "rogram.");
            ...
            this.toolTip1.SetToolTip(this.sortBtn, "Click to Sort the data. (ascending order)");
            ...
            this.toolTip1.SetToolTip(this.generateBtn, "Click to generate a new data set/list.\r\n");
            ...
            this.toolTip1.SetToolTip(this.textBox1, "Use this textfield to type in either the data you wish to search for \r\nOR to upda" +
        "te/edit the highlighted list value to match the contents of this textfield.");
            // 
            // label1
            // 
            ...
            this.toolTip1.SetToolTip(this.editBtn, "Click this, after selecting the item you wish to edit in the list, \r\nand THEN cha" +
        "nging the input textfield, \r\nto update/edit the item in the list.");
            ...
            this.toolTip1.SetToolTip(this.binarySearchBtn, "Click to Binary Search for the the Input textfield value within the data list.");
            ...
            this.toolTip1.SetToolTip(this.ModeBtn, "Click to calculate the Mode of the data list.\r\n");
            ...
            this.toolTip1.SetToolTip(this.AverageBtn, "Click to calculate the Average of the data list.\r\n");
            ...
            this.toolTip1.SetToolTip(this.RangeBtn, "Click to calculate the Range of the data list.\r\n");
            ...
            this.toolTip1.SetToolTip(this.statsBox, "This textbox will display the statistical calculations\' results, \r\nafter having c" +
        "licked one of the statistics buttons.");
            // 
            // label4
            // 
            ...
            this.toolTip1.SetToolTip(this.SeqSearchBtn, "Click to Sequentially Search for the the Input textfield value within the data li" +
        "st.");
